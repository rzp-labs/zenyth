"""Test LLM interface allows stateful implementations.

This test validates that the LLMInterface protocol allows implementations
to maintain instance state, which is necessary for tracking calls, sessions,
...
def test_llm_interface_stateful_implementation() -> None:
    """Test LLM interface allows stateful implementations."""
